...
/* harmony import */ var src_app_pages_register_event_login_member_login_member_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/pages/register-event/login-member/login-member.component */ "./src/app/pages/register-event/login-member/login-member.component.ts");
    ...
    AuthLayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                src_app_pages_register_event_login_member_login_member_component__WEBPACK_IMPORTED_MODULE_9__["EventLoginMember"]
            ]
        })
    ], AuthLayoutModule);
...
/* harmony import */ var _pages_register_event_login_member_login_member_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../pages/register-event/login-member/login-member.component */ "./src/app/pages/register-event/login-member/login-member.component.ts");
...
/* harmony import */ var _pages_register_event_register_event_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pages/register-event/register-event.component */ "./src/app/pages/register-event/register-event.component.ts");
...
var AuthLayoutRoutes = [
    ...
    { path: "event/:id/registration", component: _pages_register_event_register_event_component__WEBPACK_IMPORTED_MODULE_3__["RegisterEventComponent"] },
    { path: "event/:id/login", component: _pages_register_event_login_member_login_member_component__WEBPACK_IMPORTED_MODULE_0__["EventLoginMember"] }
];
...
/* harmony import */ var _services_attendee_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../services/attendee.service */ "./src/app/services/attendee.service.ts");
...
/* harmony import */ var src_app_services_settoken_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/settoken.service */ "./src/app/services/settoken.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, service, attendeesService, http, serviceToken, route) {
        this.router = router;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        //   this.id = get;
        // });
        var id = localStorage.getItem('im_id');
        ...
        if (this.returnUrl) {
            this.router.navigateByUrl(this.returnUrl)
                .catch(function () { return _this.router.navigate(["club-members/" + id + "/qr-code"]); });
        }
        else {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.service.postFormData(formData).subscribe(function (response) {
            ...
            var refreshToken = response.json().refresh_token;
            var accessToken = response.json().im_access_token;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])("dobi"),
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            ...
            _services_attendee_service__WEBPACK_IMPORTED_MODULE_0__["AttendeeService"],
            _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"],
            src_app_services_settoken_service__WEBPACK_IMPORTED_MODULE_6__["SettokenService"],
...
/***/ "./src/app/pages/register-event/login-member/login-member.component.html":
/*!*******************************************************************************!*\
  !*** ./src/app/pages/register-event/login-member/login-member.component.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"header bg-gradient-danger py-7 py-lg-8\">\n  <div class=\"container\">\n    <div class=\"header-body text-center mb-7\">\n      <div class=\"row justify-content-center\">\n        <div class=\"col-lg-5 col-md-6\">\n          <h1 class=\"text-white\">TRIVESG</h1>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"separator separator-bottom separator-skew zindex-100\">\n    <svg x=\"0\" y=\"0\" viewBox=\"0 0 2560 100\" preserveAspectRatio=\"none\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">\n      <polygon class=\"fill-default\" points=\"2560 0 2560 100 0 100\"></polygon>\n    </svg>\n  </div>\n</div>\n<!-- Page content -->\n<div class=\"container mt--8 pb-5\">\n  <div class=\"row justify-content-center\">\n    <div class=\"col-lg-5 col-md-7\">\n      <div *ngIf=\"done\" class=\"card bg-secondary shadow border-0\">\n        <div class=\"card-header bg-transparent pb-5\">\n          <div class=\"text-center text-muted\">\n            <h2>Register event successfully!</h2>\n            <small>Your information has been submitted and the registration is pending approval from our\n              administrator.</small>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"!done\" class=\"card bg-secondary shadow border-0\">\n        <div class=\"card-header bg-transparent\">\n          <a class=\"navbar-brand text-center\" routerLinkActive=\"active\" [routerLink]=\"['/dashboard']\">\n            <img style=\"width: 80%; margin-left: 10pt;\" src=\"assets/img/brand/logo.png\" />\n          </a>\n          <div class=\"text-center text-muted mb-4\">\n            <h2>Sign in with credentials</h2>\n          </div>\n          <form (keyup.enter)=\"login()\" role=\"form\">\n            <div *ngIf=\"invalidLogin\" class=\"alert alert-danger\">Invalid</div>\n            <div class=\"form-group mb-3\">\n              <div class=\"input-group input-group-alternative\">\n                <div class=\"input-group-prepend\">\n                  <span class=\"input-group-text\"><i class=\"ni ni-badge\"></i></span>\n                </div>\n                <input [(ngModel)]=\"orgCode\" name=\"orgCode\" class=\"form-control p-2\" placeholder=\"Organisation Code\"\n                  type=\"email\">\n\n              </div>\n            </div>\n\n            <div class=\"form-group mb-3\">\n              <div class=\"input-group input-group-alternative\">\n                <div class=\"input-group-prepend\">\n                  <span class=\"input-group-text\"><i class=\"ni ni-badge\"></i></span>\n                </div>\n                <input [(ngModel)]=\"idNumber\" name=\"idNumber\" class=\"p-2 form-control\" placeholder=\"NRIC/ID Number\"\n                  type=\"password\">\n\n              </div>\n            </div>\n\n            <div class=\"form-group\">\n              <div class=\"input-group input-group-alternative\">\n                <div class=\"input-group-prepend\">\n                  <span class=\"input-group-text\"><i class=\"ni ni-mobile-button\"></i></span>\n                </div>\n                <input [(ngModel)]=\"phone\" name=\"phone\" class=\"p-2 form-control\" placeholder=\"Phone Number\" type=\"text\">\n\n              </div>\n            </div>\n\n            <div class=\"form-group\">\n              <div class=\"input-group input-group-alternative\">\n                <div class=\"input-group-prepend\">\n                  <span class=\"input-group-text\"><i class=\"ni ni-calendar-grid-58\"></i></span>\n                </div>\n                <input #dobi class=\"form-control p-2 datepicker\" placeholder=\"Date of Birth\" name=\"dob\"\n                  [(ngModel)]=\"dob\" ngbDatepicker #d=\"ngbDatepicker\" (click)=\"d.toggle()\" type=\"text\"\n                  [startDate]=\"{year: 1990, month: 1, day: 1}\" [minDate]=\"{year: 1970, month: 1, day: 1}\" />\n\n              </div>\n\n            </div>\n          </form>\n        </div>\n        <div class=\"card-body\">\n          <form role=\"form\">\n            <div class=\"custom-control custom-control-alternative custom-checkbox\">\n              <input class=\"custom-control-input\" id=\" customCheckLogin\" type=\"checkbox\">\n              <label class=\"custom-control-label\" for=\" customCheckLogin\">\n                <span class=\"text-muted\">Remember me</span>\n              </label>\n            </div>\n            <div class=\"text-center\">\n              <button type=\"submit\" class=\"btn btn-primary my-4\" (click)=\"login()\">Sign in</button>\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/pages/register-event/login-member/login-member.component.scss":
/*!*******************************************************************************!*\
  !*** ./src/app/pages/register-event/login-member/login-member.component.scss ***!
  \*******************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3JlZ2lzdGVyLWV2ZW50L2xvZ2luLW1lbWJlci9sb2dpbi1tZW1iZXIuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/pages/register-event/login-member/login-member.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/pages/register-event/login-member/login-member.component.ts ***!
  \*****************************************************************************/
/*! exports provided: EventLoginMember */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventLoginMember", function() { return EventLoginMember; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _services_attendee_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../services/attendee.service */ "./src/app/services/attendee.service.ts");
...
var EventLoginMember = /** @class */ (function () {
    // osda
    function EventLoginMember(router, service, attendeesService, http, serviceToken, routes, atten) {
        this.router = router;
        this.service = service;
        this.attendeesService = attendeesService;
        this.http = http;
    ...
    EventLoginMember.prototype.ngOnInit = function () {
        // this.service.getDataAPI().subscribe(res => {
        //   let get = res.json()["hydra:member"]["0"]["@id"];
        //   this.id = get;
        // });
    };
    EventLoginMember.prototype.ngOnDestroy = function () { };
    EventLoginMember.prototype.login = function () {
        var _this = this;
        var tokens;
        var inputDob = this.dobi.nativeElement.value;
        var formData = new FormData();
        ...
        this.service.getRootID(snapID).subscribe(function (res) {
            ...
            _this.service.postFormData(formData).subscribe(function (response) {
                // settoken
                console.log(response.json());
                tokens = response.json().token;
                tokens.toString();
                // attendees
                _this.atten.getAtten(child, tokens).subscribe(function (res) {
                    (_this.done = true), console.log(res);
                });
            });
        });
        // Login
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])("dobi"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ElementRef"])
    ], EventLoginMember.prototype, "dobi", void 0);
    EventLoginMember = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
            selector: "login-member",
            template: __webpack_require__(/*! ./login-member.component.html */ "./src/app/pages/register-event/login-member/login-member.component.html"),
            styles: [__webpack_require__(/*! ./login-member.component.scss */ "./src/app/pages/register-event/login-member/login-member.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            _services_post_service__WEBPACK_IMPORTED_MODULE_2__["PostService"],
            _services_attendee_service__WEBPACK_IMPORTED_MODULE_1__["AttendeeService"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            src_app_services_settoken_service__WEBPACK_IMPORTED_MODULE_5__["SettokenService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
            _services_attendee_service__WEBPACK_IMPORTED_MODULE_1__["AttendeeService"]])
    ], EventLoginMember);
    return EventLoginMember;
}());
...
var RegisterEventComponent = /** @class */ (function () {
    function RegisterEventComponent(service, attendeeService, router, routes) {
        this.service = service;
...
var AttendeeService = /** @class */ (function () {
    ...
    AttendeeService_1 = AttendeeService;
    AttendeeService.prototype.postAttendee = function (attendee) {
        return this.http.post(this.url, attendee, {
            headers: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"].getHeaders()
        });
    };
    AttendeeService.getHeaders = function (token) {
        return new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Authorization': "Bearer " + token,
            'Accept': "application/ld+json"
        });
    };
    AttendeeService.prototype.getAtten = function (atten, setToken) {
        return this.http.post(this.url, atten, { headers: AttendeeService_1.getHeaders(setToken) });
    };
    var AttendeeService_1;
    AttendeeService = AttendeeService_1 = __decorate([
