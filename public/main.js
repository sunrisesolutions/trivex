...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(location, service, element, router) {
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent.prototype.ngOnInit = function () {
        ...
        this.service.getDataAPI().subscribe(function (res) {
            ...
            var id = res.json()["hydra:member"]["0"]["@id"];
            _this.uID = id;
        });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.postRegistration = function (registration) {
        return this.http.post(this.url, registration, { headers: AuthService_1.getHeaders() });
    };
    var AuthService_1;
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.uConnect = function (idPost) {
        var header = new _angular_http__WEBPACK_IMPORTED_MODULE_0__["Headers"]();
...
module.exports = __webpack_require__(/*! /home/nguyenhongphat0/Desktop/github/trivex/src/main.ts */"./src/main.ts");
