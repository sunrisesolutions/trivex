...
import {
  ...
  NbOAuth2GrantType, auth2StrategyOptions, NbOAuth2ResponseType, NbPasswordAuthStrategyOptions,
} from '@nebular/auth';
      ...
      NbPasswordAuthStrategy.setup({
        ...
        token: {
          ...
          getter: (module: string, res: HttpResponse<Object>, options: NbPasswordAuthStrategyOptions) => {
            localStorage.setItem('refresh-token', getDeepFromObject(
              res.body,
              'refresh_token',
            ));
